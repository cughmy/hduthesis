...
\title{杭州电子科技大学硕士学位论文} % 封面和题名页使用
\englishtitle{The Template of Computer Science and Technology  Thesis in \LaTeX } % 封面和题名页使用
% 如果您的标题用字过多，请自行调节 zjuthesis.cls 里的 ZJUmakecover 里的各项距离。

%\author{伊藤春希}          % 申请人姓名 封面使用
\author{君之名}
\englishauthor{Zhiming, Jun}
...
\research{图像处理}
\institute{计算机学院学院}         % 所在学位栏 填 软件学院
